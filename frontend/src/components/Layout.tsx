...
const menuItems = [
  ...
  { text: 'Venmo Tracking', icon: <AccountBalanceIcon />, path: '/venmo' },
  { text: 'Email Review', icon: <EmailIcon />, path: '/email-review' },
  { text: 'Venmo Email Tracker', icon: <EmailIcon />, path: '/venmo-email-tracker' },
